...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateDocumentsDoctrineODMCommand' => 'getGenerateDocumentsDoctrineODMCommandService.php',
            ...
            'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateRepositoriesDoctrineODMCommand' => 'getGenerateRepositoriesDoctrineODMCommandService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9FEoiAxle4', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sx2stRlwuY', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(($this->privates['doctrine_mongodb.odm.data_collector.pretty'] ?? $this->getDoctrineMongodb_Odm_DataCollector_PrettyService()));
        $instance->add($h);
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'\\vendor\\symfony\\debug-bundle/Resources/views'), '!Debug');
        $a->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\mongodb-odm-bundle/Resources/views'), 'DoctrineMongoDB');
        $a->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\mongodb-odm-bundle/Resources/views'), '!DoctrineMongoDB');
        $a->addPath(($this->targetDirs[3].'/templates'));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H3JIYpNiwT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('S3w15HAmpE', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D8vMb6HfHa', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jCqhLGmUTM', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $this->privates['doctrine_mongodb.odm.data_collector.pretty'] = $instance = new \Doctrine\Bundle\MongoDBBundle\DataCollector\PrettyDataCollector();
    ...
    {
        $a = ($this->services['doctrine_mongodb'] ?? $this->getDoctrineMongodbService());

        $b = new \Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\DoctrineParamConverter($a);

        $c = new \Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\ParamConverterManager();
        $c->add($b, 0, 'doctrine.odm');
        $c->add($b, 0, NULL);
        $c->add(new \Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\DoctrineParamConverter(($this->services['doctrine'] ?? $this->getDoctrineService()), new \Symfony\Component\ExpressionLanguage\ExpressionLanguage()), 0, 'doctrine.orm');
        $c->add(new \Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\DateTimeParamConverter(), 0, 'datetime');

        return $this->privates['sensio_framework_extra.converter.listener'] = new \Sensio\Bundle\FrameworkExtraBundle\EventListener\ParamConverterListener($c, true);
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Symfony\\Bridge\\Doctrine\\Validator\\Constraints\\UniqueEntityValidator' => function () {
            return ($this->privates['doctrine_odm.mongodb.validator.unique'] ?? $this->load('getDoctrineOdm_Mongodb_Validator_UniqueService.php'));
        ...
        $instance->addObjectInitializers(array(0 => new \Symfony\Bridge\Doctrine\Validator\DoctrineInitializer(($this->services['doctrine'] ?? $this->getDoctrineService())), 1 => new \Symfony\Bridge\Doctrine\Validator\DoctrineInitializer(($this->services['doctrine_mongodb'] ?? $this->getDoctrineMongodbService()))));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => 1,
            ...
            'console.command.ids' => array(
                ...
                11 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\ClearMetadataCacheDoctrineODMCommand',
                12 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\CreateSchemaDoctrineODMCommand',
                13 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\DropSchemaDoctrineODMCommand',
                14 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateDocumentsDoctrineODMCommand',
                15 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateHydratorsDoctrineODMCommand',
                16 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateProxiesDoctrineODMCommand',
                17 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateRepositoriesDoctrineODMCommand',
                18 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\InfoDoctrineODMCommand',
                19 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\LoadDataFixturesDoctrineODMCommand',
                20 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\QueryDoctrineODMCommand',
                21 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\ShardDoctrineODMCommand',
                22 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\TailCursorDoctrineODMCommand',
                23 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\UpdateSchemaDoctrineODMCommand',
            ),
        );
    }
}
