...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Doctrine\\Bundle\\MongoDBBundle\\Form\\Type\\DocumentType' => function () {
    return ($this->privates['form.type.mongodb_document'] ?? $this->load('getForm_Type_MongodbDocumentService.php'));
    ...
    yield 2 => ($this->privates['form.type_guesser.doctrine.mongodb'] ?? $this->load('getForm_TypeGuesser_Doctrine_MongodbService.php'));
}, 3))), ($this->privates['form.resolved_type_factory'] ?? $this->load('getForm_ResolvedTypeFactoryService.php')));
